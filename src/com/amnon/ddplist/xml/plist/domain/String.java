package com.amnon.ddplist.xml.plist.domain;

import com.amnon.ddplist.util.Stringer;
...
public class String extends PListObject implements
	 ...
	 * 
	 * @see
	 * com.amnon.ddplist.xml.plist.domain.IPListSimpleObject#getValue()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.amnon.ddplist.xml.plist.domain.IPListSimpleObject#setValue
	 * (java.lang.Object)
	 */
	@Override
